 ...
 */
public class newEName implements Screen {
    private MainCore core;
    private Stage stage;
    TextField txtInput;
    Table list;
    TextButton enterButton;
    public static String newEName;
    private Button backArrow;
    private Table titleBarOptions;

    public newEName (MainCore mainCore) {
        stage = new Stage();
        this.core = mainCore;
        list = new Table();
        ...
        txtInput.setMessageText("Type in the Employee's name Here");
